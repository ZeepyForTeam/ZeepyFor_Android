...
open class MaterialSpinner @JvmOverloads constructor(
    ...
    interface OnItemSelectedListener {
        fun onItemSelected(parent: com.example.zeepyforandroid.customview.MaterialSpinner, view: View?, position: Int, id: Long)

        fun onNothingSelected(parent: com.example.zeepyforandroid.customview.MaterialSpinner)
    }

    interface OnItemClickListener {
        fun onItemClick(parent: com.example.zeepyforandroid.customview.MaterialSpinner, view: View?, position: Int, id: Long)
    }
